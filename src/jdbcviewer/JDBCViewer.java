...
public class JDBCViewer extends Application {
	...
	public void init() throws Exception {
		...
		controller = new JDBCController().setURLBuilder(new MySQLURLBuilder());
		...
		// TODO call TableView::setPlaceholder on table and pass to it a new Label with
		// argument "No Data".
	...
	private Region createOptionsBar() throws SQLException {
		...
		// TODO create a ComboBox< String> called tablesCombo and pass to it
		// controller.getTableNames(), "Table", and 0
		ComboBox<String> tablesCombo = CommonGUIBuilder.createComboBox(controller.getTableNames(), "Table", 0);
		// TODO on controller call tableInUseProperty() and then call bind and pass to
		// it tablesCombo.getSelectionModel().selectedItemProperty()
		...
		// TODO create a Button called connectButton and pass to it "Connect" and a
		// lambda to be executed when clicked.
		...
		Button connectButton = CommonGUIBuilder.createButton("Connect", onClick -> {
		...
		// TODO create a Button called searchButton and pass to it "Search" and a lambda
		...
		// if exception is thrown, setText on conectionStatus pass to it "failed: " +
		// ex.getMessage() and call ex.printStackTrace();
		Button searchButton = CommonGUIBuilder.createButton("Search", onClick -> {
			try {
		...
		// TODO call setOnAction on searchText and use rule 3 to execute
		// searchButton.fire().
